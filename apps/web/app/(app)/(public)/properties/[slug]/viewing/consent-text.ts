/**
 * The exact GDPR-consent affirmation for the viewing-request form. Captured
 ...
 */
export const VIEWING_CONSENT_TEXT =
  'I agree that the agent may use my contact details to arrange and confirm a ' +
  'viewing of this property, in line with their privacy policy.';
