/**
 * The exact GDPR-consent affirmation for the valuation-request form. Captured
...
export const VALUATION_CONSENT_TEXT =
  'I agree that the agent may use my contact details to arrange and discuss a ' +
  'valuation of my property, in line with their privacy policy.';
