...
// Gates on `user.read` (RBAC fail-closed). Resolves the tenant, runs the read
// inside the tenant RLS scope, renders the table. Thin composition; renders inside
// the admin shell's `main` landmark. Role editing / invites (FR-H-15 write) land
// with the Better Auth staff-session work.
...
export default async function UsersPage({ searchParams }: UsersPageProps) {
  await requireStaffPermission('user.read');
