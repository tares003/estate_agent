...
// EPIC-H enquiry queue (FR-H-3) — the CRM lead queue. Gates on `enquiry.read`
// (RBAC fail-closed — the queue renders names/emails/messages). URL-driven
// (status / sort / page); resolves the tenant, runs the read inside the tenant
// RLS scope, and renders the queue table. The query/mapping logic is unit-tested
// in lib/ + queue-params.ts, so this route stays a thin composition. Renders
