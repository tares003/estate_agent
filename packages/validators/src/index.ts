...
export {
  ...
  PROPERTY_KEY_FEATURE_MAX,
  PROPERTY_KEY_FEATURES_MAX,
  PROPERTY_META_TITLE_MAX,
  PROPERTY_META_DESCRIPTION_MAX,
  ...
  type PropertyMarketStatus,
  type PropertyPriceQualifier,
  type PropertyCategory,
  type PropertyTenure,
  type PropertyCouncilTaxBand,
  type PropertyEpcRating,
  type PropertyCommercialUseClass,
  type PropertyCqcRating,
  type PropertyCreate,
  type PropertyWriteUpdate,
  type VerticalFieldIssue,
